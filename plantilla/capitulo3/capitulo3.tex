...
En la figura \ref{fig:flash1} puede verse el inicio de una de las pruebas para determinar la vida útil de una memoria y en la figura \ref{fig:flash2} como tras 26003 vueltas la capacidad y su espacio disponible no han variado. Por lo que no conseguimos los resultados esperados.
