...
Lo que hemos hecho para descubrir un poco su funcionamiento es, con el script \ref{cod:crear_mismo_tam}, llenar toda la memoria, ya que en teoría si independientemente del tamaño del fichero, en memoria ocupa 4K, si yo copio \verb|tamañoDeLaMemoriaExpresadoEnK / 4| ficheros, la memoria se llena.
