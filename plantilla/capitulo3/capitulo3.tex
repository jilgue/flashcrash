...
Después de varias pruebas con el script \verb|flash_b2.sh| \ref{cod:flash_b2} y \verb|flash_b3.sh| \ref{cod:flash_b3} no conseguimos el resultado esperado, que es obtener datos para generar una gráfica que muestre cómo disminuye la capacidad según se van deteriorando bloques de memoria.
...
En otros dos casos no conseguimos obtener datos en el momento que la memoria empezó a fallar. Pero quedó completamente inservible, ya que aunque el sistema la reconoce \ref{cod:logsistema}, ni mantiene las particiones originales \ref{cod:fdiskroto}, ni se puede acceder a ella.
