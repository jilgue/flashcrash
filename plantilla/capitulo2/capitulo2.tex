...
Este tipo de memorias están formateadas con FAT32. FAT es un sistema de archivos desarrollado para MS-DOS. FAT32 es su última evolución, utiliza direcciones de cluster de 32 KiB (aunque sólo 28 de esos KiB se utilizan realmente) y el tamaño máximo de un archivo en FAT32 es 4Gigabyte.
